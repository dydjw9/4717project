...
$cmd="SELECT * FROM 4717cart where UserID='$userid' AND Status='0';";
        ...
        <div id="nav_main_bar">
          <ul>
              ...
              <li class="active home" id="log"> 
                 <div class="bm"><a href="<?php if($Sloginstatus==1) echo "myaccount.php"; else echo "login.php"?>"><?php if($Sloginstatus==1 or $Sloginstatus==3) echo $Sfirstname; else echo "login/register"?></a></div>
                 <?php 
                $content='
              <div class="lm">
                  <ul>
...
echo '
  ...
  <table cellpadding="0" cellspacing="0" class="gwc_tb2" id="table'.$res[$i][ItemID].'">
    <tr>
      <td class="tb2_td1"><input type="checkbox" class="checkBox" checked="true"  name="isselect['.$i.']" value="'.$res[$i][ItemID].'" id="checkbox'.$res[$i][ItemID].'" onClick="getTotal();"/><label style="font-size:12px;">'.date("Y-m-d",$res[$i][Date]).'</label></td>
      ...
      <td class="tb1_td7"><button type="button" name="table'.$res[$i][ItemID].'" onClick="DeleteList('.$res[$i][ItemID].','.$i.'); ">Delete</button></td>
    </tr>
  </table>
...
?>
	...
	<table cellpadding="0" cellspacing="0" class="gwc_tb3">
		<tr>
			...
			<td class="tb3_td4"><input  class="jz2" id="jz2" type="submit"  value="CheckOut"></td>
		</tr>
	</table>
</form>
